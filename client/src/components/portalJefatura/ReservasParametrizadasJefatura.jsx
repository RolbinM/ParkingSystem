...
export function ReservasParametrizadasJefatura(){
        ...
        <div className="App" align="Center">
            ...
            <div className="container">
                ...
                <div className="row">
                        ...
                        <br />
                        <div className="mb-3">
                            <Link to={`/consultahistorialparametrizadojefatura/${params.user},${funcionario.Identificacion},${parqueo},${fechaEntrada},${fechaSalida}`}
